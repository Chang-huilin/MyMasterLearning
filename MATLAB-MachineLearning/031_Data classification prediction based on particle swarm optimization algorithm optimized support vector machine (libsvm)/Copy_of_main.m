...
%%  参数设置
pso_option.c1      = 2;                    % c1:初始为1.5, pso参数局部搜索能力
pso_option.c2      = 2;                    % c2:初始为1.7, pso参数全局搜索能力
...
pso_option.wV = 1.1;                           % wV:初始为1(wV best belongs to [0.8,1.2]),速率更新公式中速度前面的弹性系数
pso_option.wP = 1;                           % wP:初始为1,种群更新公式中速度前面的弹性系数
pso_option.v  = 7;                           % v:初始为3,SVM Cross Validation参数交叉验证
...
model = fitcsvm(t_train, p_train, cmd);
